...
import { trainings } from "@/lib/mock/trainings";
...
export default function RecentActivityTile() {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-5 col-span-1 md:col-span-2 max-h-[75vh] flex flex-col">
      {/* Titre fixe */}
        ...
        <ul className="divide-y divide-gray-200 text-sm">
          {sortedActivities.map((a, index) => (
            ...
            >
              ...
              <span className={`${a.color} font-medium text-right text-sm`}>
                {a.status}
              </span>
            </li>
          ))}
